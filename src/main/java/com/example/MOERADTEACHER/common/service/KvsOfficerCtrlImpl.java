...
public class KvsOfficerCtrlImpl {
	...
	public Object getControllerOffice(KvsControllerOffice obj) {
		...
		if(obj.getControllerType().equalsIgnoreCase("R")) {
			 qObj= nativeRepository.executeQueries("select * from kv.kv_mst_region kmr left join public.kv_controller_officer kvf on kmr.region_code =kvf.region_code::integer and kvf.is_active ='1' and kvf.controller_type ='"+obj.getControllerType()+"'");
